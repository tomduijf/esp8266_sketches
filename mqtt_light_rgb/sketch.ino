...
void callback(const MQTT::Publish& pub) {
  ...
  if (String(pub.topic()) == mqtt_col) {
    ...
    Serial1.print("Red: " + String(payload.toInt()) + ", Green: " + String(payload.substring(c1+1,c2).toInt()) + ", Blue: " + String(payload.substring(c2+1).toInt()));
    Serial1.print("Target values:");
    Serial1.print("Red: " + String(red) + ", Green: " + String(green) + ", Blue: " + String(blue));
    Serial1.print("");
